...
module.exports = async function build(value){
    ...
    const metaInfo = createMetaInfoFromOption(optionInfo,configInfo.format,configInfo.componentName)
...
function createMetaInfoFromOption(option,format,componentName="BizFormInput"){
